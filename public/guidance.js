...
const FIELD_GUIDANCE = {
    ...
    businessRegistrationNumber: {
        ...
        required: '⚠️ REQUIRED as of February 17, 2026 - carrier-driven requirement',
        example: '12-3456789 (EIN for US) or first 9 digits of CBN',
        tips: [
            '⚠️ CRITICAL: Required for ALL submissions as of February 17, 2026',
            'Legal business name MUST EXACTLY MATCH official registration records',
            'For U.S. entities: Use EIN from CP 575 EIN Confirmation Letter or IRS 147C letter',
            'For non-U.S. entities: Use official business registration number from relevant authority',
            'Format varies by identifier type (EIN: XX-XXXXXXX, CBN: first 9 digits only)',
            'Ensure correct Business Registration Identifier Type is selected',
            'DBA/trade names go in DBA field, NOT in legal business name',
            'Remove extra digits, suffixes, or formatting beyond what\'s required',
            'Use business identifier, NOT personal identifier (no SSN)'
        ],
        commonMistakes: [
            'Using DBA or trade name instead of legal business name',
            'Legal name doesn\'t match IRS/official records exactly (check punctuation, abbreviations, suffixes)',
            'Using name from W-9 or W-2 forms instead of CP 575 or IRS 147C',
            'Not combining multi-line legal names into single field when required',
            'Selecting wrong identifier type for the BRN provided',
            'Including extra digits or suffixes beyond the standard format',
            'Using SSN or personal identifier instead of business identifier',
            'Missing dashes or incorrect spacing in the number',
            'Newly registered businesses (records can take ~60 days to propagate)'
        ],
        validationFailures: {
            title: '⚠️ Common BRN Validation Failures',
            reasons: [
                '1. Legal business name mismatch (MOST COMMON) - name must match IRS or official records exactly',
                '2. Incorrect BRN value or identifier type - verify format matches identifier type',
                '3. Missing or inconsistent business details - ensure Entity Type, Identifier, and Country align',
                '4. Newly registered businesses - records may take ~60 days to appear in validation systems'
            ]
        },
        manualReview: {
            title: '📄 Manual Review Requirements',
            note: 'If validation fails despite correct information, prepare for manual review by including:',
            usEntities: 'U.S. entities: CP 575 EIN Confirmation Letter or IRS 147C letter',
            nonUsEntities: 'Non-U.S. entities: Official business registration documents from relevant authority',
            instructions: 'Upload documents to public hosting (Google Drive, Dropbox, etc.) and include the link in Additional Information field or Opt-In Image URLs field',
            tip: 'Providing these documents early speeds up manual review, though it does not guarantee automatic approval'
        },
        goodExamples: [
            '✅ EIN: 12-3456789 (with dashes, matches CP 575 letter)',
            '✅ CBN: 123456789 (first 9 digits only)',
            '✅ Legal name matches IRS records exactly: "Acme Coffee Shop LLC" not "Acme Coffee Shop, LLC"'
        ],
        badExamples: [
            '❌ Using DBA "Joe\'s Coffee" when legal name is "Joseph Smith DBA Joe\'s Coffee"',
            '❌ EIN without dashes: 123456789',
            '❌ Including extra suffixes or digits beyond standard format',
            '❌ Using SSN instead of EIN',
            '❌ Legal name from W-9 that doesn\'t match CP 575',
            '❌ Wrong identifier type selected for the number provided'
        ]
    },
